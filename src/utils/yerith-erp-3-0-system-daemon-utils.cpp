/*
 * yerith-erp-3-0-system-daemon-utils.cpp
 *
 *      Author: PROF. DR.-ENG. DIPL.-INF. Xavier Noundou
 */

#include "yerith-erp-3-0-system-daemon-utils.hpp"


#include "src/yerith-erp-3-0-system-daemon-logger.hpp"
...
QString YerothERPAlertUtils::_logFileName("yerith-erp-3-0-system-daemon.log");

/*
 * yerith-erp-3-0-system-daemon.cpp
 *
 *      Author: PROF. DR.-ENG. DIPL.-INF. Xavier Noundou
 */


#include "yerith-erp-3-0-system-daemon-db-backup-export-gz.hpp"

#include "yerith-erp-3-0-system-daemon-periode.hpp"

#include "yerith-erp-3-0-system-daemon-quantite.hpp"

#include "yerith-erp-3-0-system-daemon-config.hpp"

#include "yerith-erp-3-0-system-daemon-database.hpp"

#include "yerith-erp-3-0-system-daemon-logger.hpp"
...
{
    qDebug() <<
             "yerith-erp-3-0-system-daemon | yerith-erp-3-0-system-daemon.cpp | main. started"
             << "\n";
    ...
    qDebug() <<
             "yerith-erp-3-0-system-daemon.cpp | main | YERITH-PGI-3.0 HOME FOLDER: "
             << YerenConfig::YERITH_ERP_3_0_HOME_FOLDER;
    ...
    if (YerenConfig::YERITH_ERP_3_0_PROPERTIES_CONFIGURATION_FOLDER.isEmpty())
    {
        ...
        errMsg.append("Contacter PROF. DR.-ENG. DIPL.-INF. Xavier Noundou\n"
        			  ...
        			  "Cliquer sur 'Cancel' pour terminer yerith-erp-3-0-system-daemon-3.0");

        QDEBUG_STRING_OUTPUT_2("yerith-erp-3-0-system-daemon", errMsg);
    ...
    logFileName.append("/yerith-erp-3-0-system-daemon.log");


    QDEBUG_STRING_OUTPUT_2("yerith-erp-3-0-system-daemon.cpp | main | yerith-erp-3-0-system-daemon home folder",
    					   YerenConfig::YERITH_ERP_3_0_SYSTEM_DAEMON_HOME_FOLDER);
    ...
    QDEBUG_STRING_OUTPUT_2("yerith-erp-3-0-system-daemon.cpp | main | log file name",
    					   logFileName);
    ...
    QString initCfg(QString("%1/%2").
                    arg(YerenConfig::
                        ...
                        "yerith-erp-3-0.properties"));


    QDEBUG_STRING_OUTPUT_2("yerith-erp-3-0-system-daemon.cpp | main | yerith-erp-3-0.properties absolute file path",
    					   initCfg);
                                   ...
                                   YerothERPAlertUtils::LOCALHOST))
    {
        ...
        QString errMsg("Cette version de yerith-erp-3-0-system-daemon "
        ...
        QDEBUG_STRING_OUTPUT_2("yerith-erp-3-0-system-daemon",
    ...
    if (!database.open())
    {
        QString errMsg(QObject::
                       trUtf8("La connection de yerith-erp-3-0-system-daemon "
    ...
    //qDebug() << "yerith-erp-3-0-system-daemon.cpp | main | Database connection could be opened successfully";
    //logger << "[yerith-erp-3-0-system-daemon.cpp][main] Database connection could be opened successfully"
    //         << "\n";
